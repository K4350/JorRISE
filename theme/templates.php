...
<head>
<meta charset="utf-8">
<title>JobRISE / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+91) 9365684158</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">JobRISE <!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <address>
          <strong>JOB RISE</strong><br>
          Kaziranga University, Koraikhuwa<br>
           Pin-784144 Jorhat,ASSAM</address>
          <p>
            <i class="icon-phone"></i> (+91) 9365684158 <br>
            <i class="icon-envelope-alt"></i> kaushik4350@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; JobRISE 2023 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
