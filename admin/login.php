...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="login-box-body" style="min-height: 400px;">
      <h1 class="login-box-msg">Login to JobRISE</h1>
      <hr />
  ...
  if (isset($_POST['btnLogin'])) {
    ...
    if ($email != 'admin' || $upass != 'admin') {
      ...
      message("You logon as " . $_SESSION['Admin'] . ".", "success");
      $_SESSION['ADMIN_USERID'] = 1;
      $_SESSION['ADMIN_FULLNAME'] = "Admin";
      $_SESSION['ADMIN_USERNAME'] = "admin";
      $_SESSION['ADMIN_ROLE'] = "Administrator";
      $_SESSION['ADMIN_PICLOCATION'] = "";
