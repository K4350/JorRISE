  ...
  <!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="<?php echo web_root; ?>img/2.png" alt="" />
        ...
        <div class="container">
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <p>JobRISE offers a variety of events to facilitate the job search process. These events may include job postings, job search, application submission, and interview scheduling, as well as unique events such as virtual job shadowing, career coaching, referral programs, video interviews, employer branding services, and talent acquisition analytics.</p>
              </div>
              <div class="col-md-4">
                <div class="block-heading-two">
                ...
                <div class="block-heading-two">
                  <h3><span>Testimonials</span></h3>
                    ...
                    <div class="active item">
                      <blockquote><p>"As a technical director, I've found JobRISE to be a great partner in my search for the right candidates. Their platform allows me to quickly narrow down my search to candidates that match my requirements, saving me time and effort."</p></blockquote>
                      <div class="carousel-info">
                      <img alt="" src="img/k4350.jpg" class="pull-left">
                      <div class="pull-left">
                        <span class="testimonials-name">Kaushik Baruah</span>
